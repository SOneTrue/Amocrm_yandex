...
headers_one = {"Authorization": f'{config.reports.token_type} ' + config.yandex_token.token_three,
...
while True:
    ...
    with open("./excel/yandex_data_three.csv", 'w', encoding='utf-8') as file_one:
